  ...
  return (
    <div className="shadow-md bg-white dark:bg-gray-900 dark:text-white duration-200 fixed w-full h-28 z-40">
        ...
        <div className="container flex justify-between items-center">
          <div className="md:-ml-10 lg:-ml-0 -ml-3">
            <a href="/" className="font-bold text-2xl sm:text-l flex gap-0">
              <img src={Logo} alt="Logo" className="w-10" />Saddle
              <span className="text-secondary">Sales.com</span>
            </a>
          </div>
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-primary to-secondary transition-all duration-200 text-white  py-1 px-4 -mr-4 rounded-full flex items-center gap-3 group"
            >
              Login
            </button>
            </Link>
      ...
      <div data-aos="zoom-in" className="flex justify-start">
        <ul className="sm:flex hidden items-start gap-0">
          {Menu.map((data) => (
            <li key={data.id}>
              <a
                href={data.link}
