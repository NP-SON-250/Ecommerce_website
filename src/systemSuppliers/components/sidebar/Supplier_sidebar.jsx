  ...
  return (
    ...
    <div className=" dark:bg-gray-900 bg-yellow-800 md:w-full lg:w-[82%] w-screen h-14 border-3 lg:ml-[15.5rem]  fixed z-50 shadow-md">
        ...
        <div className="mt-4 pr-5">
            ...
            <div className="flex flex-col gap-3 md:block lg:block hidden lg:mr-10 mr-5 mt-2 text-white hover:text-primary">
      ...
      <div className="md:block lg:block hidden border-r-2 shadow-md dark:bg-gray-900 bg-yellow-800 dark:text-white duration-200 w-[20%] lg:w-[20%] md:w-[30%] h-screen z-50 fixed">
      <div className="pl-3">
            <a href="#" className="font-bold text-2xl sm:text-3xl flex gap-2">
              <img src={Logo} alt="Logo" className="w-10" />S
              <span className="text-secondary">Business</span>
